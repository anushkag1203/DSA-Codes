...
int main(){
   ...
   m.rowMajor_set(2,1,8);
   m.rowMajor_set(3,1,9);
   m.rowMajor_set(4,1,2);
   m.rowMajor_set(2,2,5);
   m.rowMajor_set(3,2,6);
   m.rowMajor_set(4,2,7);
   ...
   cout<<endl;
   Matrix m1(4);
   m1.columnMajor_set(1,1,5);
   m1.columnMajor_set(2,1,7);
   m1.columnMajor_set(3,1,1);
   m1.columnMajor_set(4,1,6);
   m1.columnMajor_set(2,2,9);
   m1.columnMajor_set(3,2,3);
   m1.columnMajor_set(4,2,7);
   m1.columnMajor_set(3,3,8);
   m1.columnMajor_set(3,4,2);
   m1.columnMajor_set(4,4,4);

   m1.columnMajor_get(3,4);
   m1.columnMajor_get(4,1);

   m1.columnMajor_display();
